def min_max():
  ...
  # print(f"The difference between the maximum and minimum values are: {difference}")
  ...
  dictionary_age = {"Tony" : 55,"Paulie" : 42,"Meadow" : 78,"Vito" : 44,"Ralph" : 24,"Sarah": 35,"Evan" : 19,"Jean" : 2,"Ned" : 49}
  
  minimum_age = min(dictionary_age.values())
  print(minimum_age)
